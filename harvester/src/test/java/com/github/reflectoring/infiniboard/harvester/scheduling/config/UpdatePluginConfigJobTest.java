...
public class UpdatePluginConfigJobTest {
  ...
  public void initializeMocks() {
    ...
    when(jobExecutionContext.getMergedJobDataMap())
        .thenReturn(
            new JobDataMap(
                Collections.singletonMap(SchedulingService.PARAM_CONTEXT, applicationContext)));
  ...
  @Test
  public void firstExecutionRetrievesAll() throws JobExecutionException {
  ...
  @Test
  public void laterExecutionsRetrieveUpdatedWidgetsOnly() throws JobExecutionException {
