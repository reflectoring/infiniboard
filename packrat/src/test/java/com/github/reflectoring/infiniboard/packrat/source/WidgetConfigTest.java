...
@SpringBootTest(classes = PackratTestApplication.class)
...
public class WidgetConfigTest {
  ...
  @Autowired private WidgetConfigRepository repository;
  ...
  public void findByTitleReturnsWidgetConfigWithSourceConfigOfSavedType() {
    ...
    assertThat(widgetConfig.getSourceConfigs().get(0))
  ...
  public void findAllByLastModifiedAfter() {
    List<WidgetConfig> widgetConfigs =
        repository.findAllByLastModifiedAfter(LocalDateTime.now().minusDays(3));
