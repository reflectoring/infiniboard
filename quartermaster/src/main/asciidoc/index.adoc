...
include::{snippets}/dashboards/create/request-fields.adoc[]
...
include::{snippets}/dashboards/create/http-request.adoc[]

===== Example Response

include::{snippets}/dashboards/create/http-response.adoc[]
...
===== Example Request
include::{snippets}/widgets/delete/http-request.adoc[]

===== Example Response

include::{snippets}/widgets/delete/http-response.adoc[]
