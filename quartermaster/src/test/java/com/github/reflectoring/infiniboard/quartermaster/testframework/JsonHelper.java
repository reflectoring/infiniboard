...
public class JsonHelper {
     ...
     *
     * @throws IOException
     *         if the JSON string could not be parsed into an object of the given target type.
     */
    ...
    /**
     * Maps the given object to JSON, ignoring the "links" property that contains the hypermedia links. This method
     * should be used for mapping request payload only, since the hypermedia links are expected in response payloads.
     */
    ...
    /**
     * Parses the given JSON string into a PagedResources object using a Jackson mapper configured for HAL type HATEOAS
     * resources.
     *
     * @param json
     *         the JSON string to parse.
     * @param contentType
     *         class of the type of the objects contained within the PagedResources wrapper.
     * @param <T>
     *         the type of the objects contained within the PagedResources wrapper.
     *
