...
public class WidgetConfigResourceAssemblerTest {
    ...
    private Map<String, Object> addUsernameToConfigData(Map<String, Object> configData, String username) {
    ...
    private Map<String, Object> addPasswordToConfigData(Map<String, Object> configData, String password) {
        HashMap<String, Object> newConfigData = new HashMap<>(configData);
    ...
    public void toResourceMasksUsernameAndPassword() {
        ...
        WidgetConfigResourceAssembler assembler = createAssembler();
        WidgetConfigResource          resource  = assembler.toResource(createWidgetWithConfiguredUsernameAndPassword());
