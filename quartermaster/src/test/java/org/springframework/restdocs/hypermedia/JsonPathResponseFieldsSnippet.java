...
/**
 * Documentation snippet that doesn't document ALL fields of a response but only a part
 * of the response that matches a certain JSON path string.
 */
public class JsonPathResponseFieldsSnippet extends AbstractFieldsSnippet {
    ...
    /**
     *
     * @param jsonPath the JSON path that defines the section of the response JSON structure to document.
