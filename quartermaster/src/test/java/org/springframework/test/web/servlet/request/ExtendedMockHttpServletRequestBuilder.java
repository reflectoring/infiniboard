...
/**
 * Extension of the MockHttpServletRequestBuilder provided by Spring to support multipart requests via PUT.
 */
public class ExtendedMockHttpServletRequestBuilder extends MockHttpServletRequestBuilder {
    ...
    ExtendedMockHttpServletRequestBuilder(String urlTemplate, HttpMethod method, Object... urlVariables) {
    ...
    /**
     * Create a new {@link MockMultipartHttpServletRequest} based on the supplied {@code ServletContext} and the {@code
     * MockMultipartFiles} added to this builder.
     */
    @Override
